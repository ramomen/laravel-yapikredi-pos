...
// use App\PosnetPayment\posnet_xml;


// Include posnet http library
require_once('posnet_http.php');
// use App\PosnetPayment\posnet_http;
// use App\PosnetPayment\PosnetHTTPConection;
